        ...
        def on_mouse_changed(watcher, payload):
            try:
                ...
                mouse_report = self.report_builder.build_mouse_report(
                    payload['buttons'], payload['rel_x'], payload['rel_y'], payload['scroll_v'], payload['last_code']
                )
